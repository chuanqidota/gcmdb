...
type AuditLog struct {
	...
	Username     string    `gorm:"column:username;size:64;index;comment:操作人" json:"username"`
	BeforeData   string    `gorm:"column:before_data;type:text;comment:变更前数据" json:"before_data"`
	AfterData    string    `gorm:"column:after_data;type:text;comment:变更后数据" json:"after_data"`
